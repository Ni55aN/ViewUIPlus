import { getCurrentInstance, Fragment, Comment, Text, h } from "vue";
  ...
  props: {
    size: {
      ...
      default() {
        ...
        return !global.$VIEWUI || !global.$VIEWUI.space || global.$VIEWUI.space.size === "" ? "small" : global.$VIEWUI.space.size;
      }
    },
    direction: {
      type: String,
